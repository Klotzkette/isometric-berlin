...
6144×4356 double-click overview; their complete 68-file 3D scene is unchanged.
...
footprints + measured heights (133,060 building columns on a 4 m grid, stepped
...
block surround carries the same versioned 5,130 m envelope, park bands, tree
