...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function tl(e,t,n){let r=new Float32Array(Vc),i=new G(0,1,0);return new $o({name:`SphericalGaussianBlur`,defines:{n:Vc,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:il(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function nl(){return new $o({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:il(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function rl(){return new $o({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:il(),fragmentShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},Ef={name:`SMAAWeightsShader`,defines:{SMAA_MAX_SEARCH_STEPS:`8`,SMAA_AREATEX_MAX_DISTANCE:`16`,SMAA_AREATEX_PIXEL_SIZE:`( 1.0 / vec2( 160.0, 560.0 ) )`,SMAA_AREATEX_SUBTEX_SIZE:`( 1.0 / 7.0 )`},uniforms:{tDiffuse:{value:null},tArea:{value:null},tSearch:{value:null},resolution:{value:new W(1/1024,1/512)}},vertexShader:`
		...
		}`},Df={name:`SMAABlendShader`,uniforms:{tDiffuse:{value:null},tColor:{value:null},resolution:{value:new W(1/1024,1/512)}},vertexShader:`
