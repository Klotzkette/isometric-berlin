  ...
  JSON.stringify(
    {
      ...
      renderables,
      bufferBytes,
      sourceTrees: world.userData.sourceVoxelTreeCount,
      visibleTrees: world.userData.visibleVoxelTreeCount,
      signatureTrees: world.userData.lenneOakVoxelReplacementCount,
