...
const DE = {
  ...
  pedestrianOn: "Spaziergänger-Modus · Start am Pariser Platz",
  previous: "Zurück",
  ...
  tunnelNorthbound: "Tunnel-Durchflug nach Norden",
  tunnelSouthbound: "Tunnel-Durchflug nach Süden",
...
const EN: Record<CopyKey, string> = {
  ...
  pedestrianOn: "Pedestrian mode · start at Pariser Platz",
  previous: "Back",
  ...
  tunnelNorthbound: "Fly through the tunnel northbound",
  tunnelSouthbound: "Fly through the tunnel southbound",
  underside: "Underside",
