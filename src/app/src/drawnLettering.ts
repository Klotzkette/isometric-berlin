...
// visually identical Cyrillic capitals share their Latin paths; the remaining
// forms are defined on the same unit grid below.
const CYRILLIC_GLYPH_ALIASES = {
  А: "A",
  В: "B",
  Е: "E",
  К: "K",
...
for (const [cyrillic, latin] of Object.entries(CYRILLIC_GLYPH_ALIASES)) {
