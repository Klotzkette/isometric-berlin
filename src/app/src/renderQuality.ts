 ...
 * movement step. A tenth of a second preserves wall-clock navigation speed
 * down to 10 fps while collision and camera interpolation remain bounded.
 */
export const MAX_MOTION_FRAME_DELTA_SECONDS = 0.1;
