...
export const KONRAD_ADENAUER_HAUS_PROFILE = {
  ...
  innerBodyDepthM: 30,
  innerBodyLengthM: 54,
  innerBodyLowerHeightM: 18,
  innerBodyRotationY: (-53.84 * Math.PI) / 180,
  osmWayId: "25999445",
  publishedUsableAreaM2: 6_300,
  signageRendered: true,
  identificationSign: {
    text: "CDU",
    widthM: 3.9,
    heightM: 1.7,
    heightAboveGroundM: 16.2,
    geometryStatus: "current 2024 photographed white identification panel and dark CDU lettering; local dimensions and placement on the curved bow are display estimates",
  },
  facadeStatus: "photograph-bound window ribbons, paired curtain-wall registers, recessed glazed entrance and contiguous six-level office body; local spacing remains non-surveyed",
  ...
  sources: [
    ...
    "https://commons.wikimedia.org/wiki/File%3A141101_Berlin_Konrad-Adenauer-Haus.jpg",
    "https://commons.wikimedia.org/wiki/File%3ABerlin_Konrad-Adenauer-Haus-20241207-RM-102533.jpg",
  ] as const,
} as const;
