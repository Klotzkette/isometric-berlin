...
top-down OSM/LoD2 reference map overlay with north arrow and scale for
placement checks. The committed DZI uses the deterministic local
pixel-art pass; it does not need a backend, AI model, or Google key at
runtime.
