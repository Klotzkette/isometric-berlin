...
LANDMARK_EXPECTATIONS: dict[str, dict[str, Any]] = {
  ...
  "Taxistand Washingtonplatz": {
    "aliases": ["s u hauptbahnhof washingtonplatz"],
    "osm_ids": ["1221586319"],
    "max_distance_m": 5.0,
  },
  "Parlament der Bäume gegen Krieg und Gewalt": {
    "aliases": ["parlament der baume"],
    "osm_ids": ["208945077"],
    "max_distance_m": 5.0,
  },
  "Bahnhof Berlin Friedrichstraße": {
    "aliases": ["berlin friedrichstrasse"],
    "osm_ids": ["530812080"],
    "max_distance_m": 5.0,
  },
  "Bundesministerium der Finanzen / Detlev-Rohwedder-Haus": {
    "aliases": ["bundesministerium der finanzen"],
    "osm_ids": ["280070"],
    "max_distance_m": 5.0,
  },
...
RELATIVE_EXPECTATIONS: tuple[dict[str, str], ...] = (
  {
    ...
    "to": "Tramhaltestelle S+U Hauptbahnhof",
    "east_west": "east",
    "north_south": "north",
    "note": "The tram platforms are on Europaplatz north of Hauptbahnhof.",
  },
  {
    "from": "Tramhaltestelle S+U Hauptbahnhof",
    "to": "S15-Station Berlin Hauptbahnhof",
    "east_west": "west",
    "north_south": "north",
    "note": "The provisional S15 entrance lies north-west of the tram anchor.",
  },
  {
    "from": "Berlin Hauptbahnhof",
    "to": "Oggi's Gemüsekebab",
    "east_west": "west",
    "north_south": "north",
    "note": "Oggi's lies north-west at the south end of Heidestraße.",
  },
  {
    "from": "Berlin Hauptbahnhof",
    "to": "Taxistand Washingtonplatz",
    "east_west": "east",
    "north_south": "south",
    "note": "The taxi/mobility hub lies south-east on Washingtonplatz.",
  },
  {
    "from": "Berlin Hauptbahnhof",
    "to": "Futurium",
    "east_west": "east",
    "north_south": "south",
    "note": "Futurium lies east and slightly south of Hauptbahnhof.",
  },
  {
    "from": "Marie-Elisabeth-Lüders-Haus",
    "to": "Parlament der Bäume gegen Krieg und Gewalt",
    "east_west": "west",
    "north_south": "north",
    "note": "The memorial garden lies just north-west of the parliamentary building.",
  },
  {
    ...
    "east_west": "east",
    "north_south": "north",
    "note": "Berliner Ensemble lies east and north across the Spree.",
  },
  {
  ...
  },
  {
    ...
    "to": "Bundesministerium der Finanzen / Detlev-Rohwedder-Haus",
    "east_west": "east",
    "north_south": "south",
    "note": "The Detlev-Rohwedder-Haus lies south-east of Brandenburg Gate.",
  },
  {
    "from": "Bundesministerium der Finanzen / Detlev-Rohwedder-Haus",
    "to": "Gropius Bau",
    "east_west": "west",
    "north_south": "south",
    "note": "Gropius Bau lies south-west of the finance ministry.",
  },
  {
    "from": "Gropius Bau",
    "to": "Topographie des Terrors",
    "east_west": "east",
    "north_south": "south",
    "note": "The Topography site lies immediately east and south of Gropius Bau.",
  },
  {
    "from": "Gropius Bau",
    "to": "Abgeordnetenhaus von Berlin",
    "east_west": "west",
    "north_south": "north",
    "note": "The former Prussian Landtag lies north-west of Gropius Bau.",
  },
  {
    "from": "Berlin Hauptbahnhof",
