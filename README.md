...
| Versioned v0.5.3 ZIP | https://github.com/Klotzkette/isometric-berlin/releases/download/v0.5.3/isometric-berlin-regierungsviertel-local.zip |
...
**Status:** Public open-data project · **Local v0.5.3** · hosted viewer and a
...
The current public package is **v0.5.3**, built from `main`. Its full viewer is a progressively
