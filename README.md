...
| Versioned v0.70.11 ZIP | https://github.com/Klotzkette/isometric-berlin/releases/download/v0.70.11/isometric-berlin-regierungsviertel-local.zip |
...
**Status:** Public open-data project · **Local v0.70.11** · hosted viewer and a
...
The current public package is **v0.70.11**, built from `main`. Its full viewer is a progressively
