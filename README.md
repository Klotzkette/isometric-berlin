...
| Versioned v0.71.28 ZIP | https://github.com/Klotzkette/isometric-berlin/releases/download/v0.71.28/isometric-berlin-regierungsviertel-local.zip |
...
**Status:** Public open-data project · **Local v0.71.28** · hosted viewer and a
...
The current public package is **v0.71.28**, built from `main`. Its full viewer
...
- **The Bundeskanzleramt forecourt no longer contains an invented white
  ...
  fence, lamps and paved approach remain unchanged.
