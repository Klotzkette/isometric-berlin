...
| Versioned v0.71.26 ZIP | https://github.com/Klotzkette/isometric-berlin/releases/download/v0.71.26/isometric-berlin-regierungsviertel-local.zip |
...
**Status:** Public open-data project · **Local v0.71.26** · hosted viewer and a
...
The current public package is **v0.71.26**, built from `main`. Its full viewer
