...
| Versioned v0.71.18 ZIP | https://github.com/Klotzkette/isometric-berlin/releases/download/v0.71.18/isometric-berlin-regierungsviertel-local.zip |
...
**Status:** Public open-data project · **Local v0.71.18** · hosted viewer and a
...
The current public package is **v0.71.18**, built from `main`. Its full viewer
