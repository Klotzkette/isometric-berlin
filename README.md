...
| Versioned v0.8.1 ZIP | https://github.com/Klotzkette/isometric-berlin/releases/download/v0.8.1/isometric-berlin-regierungsviertel-local.zip |
...
**Status:** Public open-data project · **Local v0.8.1** · hosted viewer and a
...
The current public package is **v0.8.1**, built from `main`. Its full viewer is a progressively
