...
| Versioned v0.71.17 ZIP | https://github.com/Klotzkette/isometric-berlin/releases/download/v0.71.17/isometric-berlin-regierungsviertel-local.zip |
...
**Status:** Public open-data project · **Local v0.71.17** · hosted viewer and a
...
The current public package is **v0.71.17**, built from `main`. Its full viewer
...
- **The Tiergartentunnel now meets the surface as a real road structure.** The
  north entrance at Hauptbahnhof and the Kemperplatz entrance have continuous
  twin carriageways, joined curved ramps, retaining walls, low portal beams,
  lane controls and a lit 46 m transition behind each opening. The Kemperplatz
  plan course is regenerated from its two mapped OSM surface carriageways;
  ordinary exterior views still hide the buried tunnel body.
