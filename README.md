...
| Versioned v0.71.30 ZIP | https://github.com/Klotzkette/isometric-berlin/releases/download/v0.71.30/isometric-berlin-regierungsviertel-local.zip |
...
**Status:** Public open-data project · **Local v0.71.30** · hosted viewer and a
...
The current public package is **v0.71.30**, built from `main`. Its full viewer
