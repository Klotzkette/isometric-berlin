...
| Versioned v0.53.1 ZIP | https://github.com/Klotzkette/isometric-berlin/releases/download/v0.53.1/isometric-berlin-regierungsviertel-local.zip |
...
The current public package is **v0.53.1**, built from `main`. Its full viewer is a progressively
