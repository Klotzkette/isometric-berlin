...
| Versioned v0.70.6 ZIP | https://github.com/Klotzkette/isometric-berlin/releases/download/v0.70.6/isometric-berlin-regierungsviertel-local.zip |
...
**Status:** Public open-data project · **Local v0.70.6** · hosted viewer and a
...
The current public package is **v0.70.6**, built from `main`. Its full viewer is a progressively
