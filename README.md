...
| Versioned v0.71.37 ZIP | https://github.com/Klotzkette/isometric-berlin/releases/download/v0.71.37/isometric-berlin-regierungsviertel-local.zip |
...
**Status:** Public open-data project · **Local v0.71.37** · hosted viewer and a
...
The current public package is **v0.71.37**, built from `main`. Its full viewer
is a progressively loaded, freely orbitable 3D scene; the double-click HTML
remains a clearly labelled compatibility fallback for browsers that cannot run
local modules.

- **The Reichstag now opens on its actual west elevation.** The default lawn
  camera presents the six-column portico, `DEM DEUTSCHEN VOLKE`, the corner
  pavilions and Foster dome together. Arched stone reveals, the wing order,
  rusticated basement windows, cornice dentils, sculptural fields and entrance
  glazing add the facade rhythm visible in the frontal reference while the
  official LoD2 footprint, height and orientation remain unchanged.
