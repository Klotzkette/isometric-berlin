...
| Versioned v0.22.0 ZIP | https://github.com/Klotzkette/isometric-berlin/releases/download/v0.22.0/isometric-berlin-regierungsviertel-local.zip |
...
**Status:** Public open-data project · **Local v0.22.0** · hosted viewer and a
...
The current public package is **v0.22.0**, built from `main`. Its full viewer is a progressively
