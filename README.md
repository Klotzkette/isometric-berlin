...
| Versioned v0.71.16 ZIP | https://github.com/Klotzkette/isometric-berlin/releases/download/v0.71.16/isometric-berlin-regierungsviertel-local.zip |
...
**Status:** Public open-data project · **Local v0.71.16** · hosted viewer and a
...
The current public package is **v0.71.16**, built from `main`. Its full viewer
