...
| Versioned v0.71.19 ZIP | https://github.com/Klotzkette/isometric-berlin/releases/download/v0.71.19/isometric-berlin-regierungsviertel-local.zip |
...
**Status:** Public open-data project · **Local v0.71.19** · hosted viewer and a
...
The current public package is **v0.71.19**, built from `main`. Its full viewer
