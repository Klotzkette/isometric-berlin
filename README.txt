Isometric Berlin - Regierungsviertel 1.0.26
==============================================
...
Seit v1.0.17: Das Botschaftsband südlich des Tiergartens, der Robert-Koch-Platz
...
Neu in v1.0.14: Richtige Grundrisse am Humboldthafen bereits beim Start,
freie Höfe und freie Wasserflächen; genaueres Wirtschaftsministerium mit
Altbau, Neubau und Solaranlage. Alle erfassten Friedhofsgräber auch in Minecraft.
...
Zusammenhaengende Promenade und gepflegte Gruenflaechen am Spreebogen.
Eigene Minecraft-Geometrie fuer Desktop und Mobilgeraete.
...
und Guenter-Litfin-Turm werden in allen Darstellungen genauer.
...
Seit v1.0.1: Abgeordnetenhaus und Gropius Bau erhalten eigene,
...
Version 1.0.26 hat zusätzlich Atlas/Cinematic/Lab-Grafikprofile,
...
Version 1.0.26 setzt den Fußgängermodus senkrecht unter die aktuelle
...
Version 1.0.26 rekonstruiert das Sozialgericht Berlin anhand der
...
Version 1.0.26 baut das Beethoven-Haydn-Mozart-Denkmal als zehn
...
Version 1.0.26 gibt Europa-Center, Allianz-Haus, altem Café Kranzler
...
Version 1.0.26 hält die temporäre FUNBOX vollständig auf ihrer
...
Version 1.0.26 gibt dem Geschichtspark Zellengefängnis Moabit ein
...
Version 1.0.26 verankert das Richard-Wagner-Denkmal als 90.
...
geladen.
Version 1.0.26 macht die Weidendammer Brücke als 91.
...
Version 1.0.26 gibt dem Max-Liebermann-Haus, der Französischen und
...
Version 1.0.26 rekonstruiert außerdem Goethe und Lessing an ihren
...
Version 1.0.26 verfeinert außerdem das Forum des ehemaligen Sony
...
Version 1.0.26 verkleinert den offenen Dachring des Berliner
...
Version 1.0.26 ergänzt außerdem die neue, vom vorhandenen
...
Version 1.0.26 versetzt 1.093 Ampelmasten an deterministische äußere
...
Version 1.0.26 lässt genau neun amtliche Staatsfahnen in Tag, Nacht,
...
erhalten.
Version 1.0.26 richtet Hotel Adlon und Starbucks an ihren echten
...
Version 1.0.26 zeigt das als 93. Sehenswürdigkeit anwählbare
...
Version 1.0.26 ergänzt außerdem eine Szenen-Detail-Ebene mit zwei
...
Version 1.0.26 ergänzt einen gespeicherten Leichtmodus mit Taste P.
...
Version 1.0.26 kann außerdem gezielt mit URL-Parametern gestartet
...
Version 1.0.26 formt den Tunnel weiter aus: Unterseitenmodus,
...
In Version 1.0.26 ist die Minecraft-Hauptarchitektur bewusst gröber
...
Im mobilen Touch-Profil begrenzt Version 1.0.26 den Minecraft-
...
Version 1.0.26 entfernt die 74 nie mehr dargestellten Foto-GLBs und
...
Version 1.0.26 erweitert den sichtbaren Radius auf 6.450 m und
...
Potsdamer Platz, Europacity and Charité, present in the initial drawn city.
...
Since v1.0.17: The diplomatic quarter south of Tiergarten, Robert-Koch-Platz
...
entrances gain visible glass doors, canopies and institutional lettering.

New in v1.0.14: Correct Humboldthafen footprints from startup, open courts
and clear water; refined historic and modern ministry roofs with solar panels.
All mapped cemetery graves remain visible in Minecraft.
...
rooflights and entrance pavilion at the Musical Instrument Museum.
Continuous promenade and source-bound planting at Spreebogen, with
native Minecraft geometry for desktop and mobile.
...
gains its complete structure and finished extension. Invalidenfriedhof
and the Guenter Litfin tower gain accurate details in every visual mode.
...
Since v1.0.1: the Abgeordnetenhaus and Gropius Bau gain dedicated,
...
Version 1.0.26 also adds Atlas/Cinematic/Lab visual profiles, a
...
8.5 MP on desktop.
Version 1.0.26 enters pedestrian mode directly below the current
...
Version 1.0.26 reconstructs Sozialgericht Berlin from the six
...
Version 1.0.26 rebuilds the Beethoven-Haydn-Mozart memorial as its
...
Version 1.0.26 gives Europa-Center, Allianz-Haus, the historic Café
...
Version 1.0.26 keeps the temporary FUNBOX completely on its display
...
Version 1.0.26 gives the Geschichtspark Zellengefängnis Moabit a
...
Version 1.0.26 anchors the Richard-Wagner-Denkmal as the 90th
...
loaded.
Version 1.0.26 makes Weidendammer Brücke selectable as sight 91.
...
Version 1.0.26 gives the Max-Liebermann-Haus, French Embassy, US
...
Version 1.0.26 also reconstructs Goethe and Lessing at their exact
...
directions open.
Version 1.0.26 also deepens the former Sony Center Forum with its
...
Version 1.0.26 reduces the Berliner Ensemble open roof ring to a
...
Version 1.0.26 also adds the new CSD memorial place at exact OSM
...
Version 1.0.26 moves 1,093 traffic-signal poles to deterministic
...
Version 1.0.26 gives exactly nine official state flags a gentle
...
Version 1.0.26 aligns Hotel Adlon and Starbucks to their real
...
Version 1.0.26 renders Scharnhorst's grave, selectable as sight 93,
...
Version 1.0.26 also adds a scene-detail layer with two translucent
...
Version 1.0.26 adds a saved Lite mode on key P. It reduces expensive
...
Version 1.0.26 can also start with URL parameters such as
...
Version 1.0.26 further shapes the tunnel with an underside mode,
...
In version 1.0.26, Minecraft's principal architecture is
...
Version 1.0.26 bounds Minecraft in the mobile-like touch profile,
...
Version 1.0.26 removes all 74 retired photographic GLBs and the
...
Version 1.0.26 extends the visible radius to 6,450 m and carries an
